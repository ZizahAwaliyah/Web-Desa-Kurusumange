...
export const lembagaDesa = [
  {
    ...
    ketua: 'Abd. Rahman',
    deskripsi: 'Lembaga yang melaksanakan fungsi pemerintahan yang anggotanya merupakan wakil penduduk desa berdasarkan keterwakilan wilayah dan ditetapkan secara demokratis',
    warna: 'bg-blue-900',
  },
  {
    nama: 'BUMDesa',
  ...
  {
    nama: 'PKK',
    subtitle: 'Pemberdayaan dan Kesejahteraan Keluarga ',
    ketua: 'Hj. Nurhayati',
    deskripsi: 'Organisasi sosial kemasyarakatan sebagai wadah pembinaan dan pengembangan generasi muda desa di bidang kesejahteraan sosial.',
    warna: 'bg-yellow-700',
  },
]